...
}).catch(function(e) { console.log(“DB save error”, e); });
}

function dbUpdatePlan(userId, plan) {
fetch(SUPABASE_URL + “/rest/v1/cashdrop_users?id=eq.” + userId, {
method: “PATCH”,
headers: {
“Content-Type”: “application/json”,
“apikey”: SUPABASE_KEY,
...
}).catch(function(e) { console.log(“DB update error”, e); });
}

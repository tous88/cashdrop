...
function dbSaveUser(user) {
  ...
  return fetch(SUPABASE_URL + "/rest/v1/cashdrop_users", {
    method: "POST",
  ...
  }).then(function(r) { return r.json(); }).then(function(d) { console.log("Saved:", d); }).catch(function(e) { console.log("DB error", e); });
}
